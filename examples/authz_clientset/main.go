...
import (
	...
	"github.com/opsdata/elmt-sdk/wyvern"
)
...
func main() {
	...
	clientset, err := wyvern.NewForConfig(config)
	if err != nil {
		panic(err.Error())
	}
	...
	ret, err := clientset.Elmt().AuthzV1().Authz().Authorize(context.TODO(), request, metav1.AuthorizeOptions{})
	if err != nil {
		panic(err.Error())
	}
